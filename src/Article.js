...
class Article extends Component {
    constructor (props){
        ...
        this.onCountLikes = this.onCountLikes.bind(this);
         // console.log ('article', props.data.bornDate);
    }
    render() {
            ...
            return (
                ...
                <div className="card container pl-5">
                    ...
                    <a className="mb-3" href="#">
                        <img className="rounded mx-auto d-block" alt={this.props.data.name}
                             src={this.props.data.imageUrl} width="80%"/>
                    </a>


                    <h3 className="text-center">
                        <a href="#" onClick={this.handleClick}
                           style={{textDecoration: 'none'}}>{this.props.data.name}</a>
                    </h3>
                    ...
                    <ul className="list-unstyled d-flex justify-content-start mb-3 font-italic">
                        <li className="mr-3">
                            <small>Дата добавления рецепта: &nbsp;{this.props.data.bornDate}</small>
                        </li>
                        <li>
                            <small>Последнее редактирование: &nbsp;{this.props.data.redactDate}</small>
                        </li>
                    </ul>
                </div>
